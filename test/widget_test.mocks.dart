...
// in seektest/test/widget_test.dart.
...
import 'package:seektest/app/data_source/task/task_data_source.dart' as _i2;
import 'package:seektest/app/entity_models/task/task_entity.dart' as _i5;
import 'package:seektest/app/enums/filter_enum.dart' as _i6;
import 'package:seektest/app/repository/task_repository.dart' as _i3;
...
class MockTaskRepository extends _i1.Mock implements _i3.TaskRepository {
  ...
  @override
  _i4.Future<void> completeTask(int? taskId) => (super.noSuchMethod(
        Invocation.method(
          #completeTask,
          [taskId],
        ),
